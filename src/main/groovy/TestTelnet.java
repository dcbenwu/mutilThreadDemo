...
public class TestTelnet {
     ...
     */
    public TestTelnet(String server, int port, int timeout) throws Exception{
    ...
    public TestTelnet(String server, int port, int timeout, boolean debug) throws Exception{
    ...
    public static void main(String[] args) {
        try {
            ...
            while (true) {
                ...
                // 172.29.160.15,
                TestTelnet telnet = new TestTelnet("172.29.151.72", 3083, 1000 * 3);
